 ...
 */
public class AutoCompletion2 extends JComboBox {
    ...
    public AutoCompletion2(final JComboBox comboBox) {
        this.comboBox = comboBox;
        this.document = new AutoCompletionDocument(comboBox);
    ...
    public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
        ...
        Object item = lookupItem(document.getText(0, document.getLength()));
        if (item != null) {
